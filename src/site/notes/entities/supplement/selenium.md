---
created: '2026-02-08T19:45:44.660307Z'
...
title: Selenium
type: supplement
updated: '2026-02-08T19:45:44.660307Z'
---

# Selenium

## Overview
Essential trace mineral critical for thyroid function, antioxidant defense (glutathione peroxidase), and immune function. Required for T4 to T3 conversion.
...
```yaml
last_modified: '2026-01-26T06:42:54.359267'
source: obsidian
```
...
- → [[Glutathione]] (metabolite)
```yaml
last_modified: '2025-12-28T11:01:26.048808'
source: obsidian
```
...
- → [[Thyroid_Hormones]] (hormone)
```yaml
last_modified: '2025-12-28T11:01:25.899839'
source: obsidian
```
...
- → [[Immune_System]] (organ)
```yaml
last_modified: '2025-12-28T11:01:25.875218'
source: obsidian
```
- → [[Thyroid]] (organ)
```yaml
last_modified: '2025-12-28T11:01:25.850133'
source: obsidian
```
