---
created: '2026-02-08T19:45:44.656099Z'
...
title: Magnesium
type: supplement
updated: '2026-02-08T19:45:44.656099Z'
---

# Magnesium

## Overview
Essential mineral cofactor involved in over 300 enzymatic reactions, including energy production, protein synthesis, blood glucose control, and blood pressure regulation. One of the most common nutritional deficiencies in Western diets.
...
- ← [[Muscles]] (organ)
```yaml
last_modified: '2026-01-26T07:08:09.931719'
source: obsidian
```
...
- ← [[GABA]] (supplement)
```yaml
last_modified: '2026-01-26T07:08:37.177034'
source: obsidian
```
...
- ← [[Bones]] (organ)
```yaml
last_modified: '2026-01-26T07:08:07.801004'
source: obsidian
```
- ← [[Brain]] (organ)
```yaml
...
- → [[Chronic_Inflammation]] (condition)
```yaml
last_modified: '2025-12-28T11:01:22.460852'
source: obsidian
```
...
- → [[Heart]] (organ)
```yaml
last_modified: '2025-12-28T11:01:22.079457'
source: obsidian
```
- → [[Bones]] (organ)
```yaml
last_modified: '2025-12-28T11:01:22.156460'
source: obsidian
```
- → [[Muscles]] (organ)
```yaml
last_modified: '2025-12-28T11:01:22.105891'
source: obsidian
```
- → [[Brain]] (organ)
```yaml
last_modified: '2025-12-28T11:01:22.132209'
source: obsidian
```
...
- ← [[L-Theanine]] (supplement)
```yaml
last_modified: '2025-12-28T11:01:21.354571'
source: obsidian
```
- ← [[Melatonin_Supplement]] (supplement)
```yaml
...
- ← [[Vitamin_B6]] (supplement)
```yaml
last_modified: '2025-12-28T11:01:27.026228'
source: obsidian
```
- ← [[Zinc]] (biomarker)
```yaml
last_modified: '2025-12-28T11:01:28.820480'
source: obsidian
```
- → [[Vitamin_B6]] (supplement)
```yaml
last_modified: '2025-12-28T11:01:22.793036'
source: obsidian
```
- → [[Ashwagandha]] (supplement)
```yaml
...
- → [[Insulin]] (biomarker)
```yaml
last_modified: '2025-12-28T11:01:22.240342'
source: obsidian
```
...
- → [[GABA]] (supplement)
```yaml
last_modified: '2025-12-28T11:01:22.304149'
source: obsidian
```
...
- → [[ATP]] (metabolite)
```yaml
last_modified: '2025-12-28T11:01:22.327788'
source: obsidian
```
...
- → [[CoQ10]] (supplement)
```yaml
last_modified: '2025-12-28T11:01:22.768344'
source: obsidian
```
- → [[Vitamin_B6]] (supplement)
```yaml
...
- ← [[Insulin]] (biomarker)
```yaml
last_modified: '2026-01-19T09:30:20.629285'
source: obsidian
```
- ← [[Ashwagandha]] (drug)
```yaml
...
- ← [[Bones]] (organ)
```yaml
last_modified: '2026-01-19T09:33:01.319866'
source: obsidian
```
- ← [[Brain]] (organ)
```yaml
...
- ← [[Muscles]] (organ)
```yaml
last_modified: '2026-01-19T09:33:09.375355'
source: obsidian
```
- ← [[Anxiety]] (phenotype)
```yaml
...
- ← [[GABA]] (supplement)
```yaml
last_modified: '2026-01-19T09:07:03.738932'
source: obsidian
```
- ← [[L-Theanine]] (supplement)
```yaml
