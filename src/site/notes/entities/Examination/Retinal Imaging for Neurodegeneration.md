---
{"dg-publish":true,"permalink":"/entities/examination/retinal-imaging-for-neurodegeneration/","tags":["examination","retina","neurodegeneration","screening","cutting-edge","non-invasive"]}
---
...
### Conditions
- → [[entities/condition/Alzheimer's Disease\|Alzheimer's Disease]] (condition) - *RNFL thinning, vascular changes*
- → [[entities/condition/Parkinson's Disease\|Parkinson's Disease]] (condition) - *RNFL and foveal changes*
- → [[Multiple Sclerosis\|Multiple Sclerosis]] (condition) - *Established use for monitoring*
- → [[entities/condition/Vascular Dementia\|Vascular Dementia]] (condition) - *Retinal vascular changes*
- → [[entities/condition/Glaucoma\|Glaucoma]] (condition) - *RNFL monitoring (confounder)*

### Brain Regions (Correlations)
- → [[entities/Organ/Hippocampus\|Hippocampus]] (organ) - *RNFL correlates with volume*
- → [[Visual Cortex\|Visual Cortex]] (organ) - *Retrograde degeneration*
- → [[Optic Nerve\|Optic Nerve]] (organ) - *Direct connection*

### Related Biomarkers
- → [[entities/biomarker/Plasma p-tau217\|Plasma p-tau217]] (biomarker) - *Complementary blood marker*
- → [[entities/biomarker/Blood NfL\|Blood NfL]] (biomarker) - *Neurodegeneration correlation*

### Related Imaging
- ← [[entities/Examination/MRI Volumetry\|MRI Volumetry]] (examination) - *Brain structural correlate*
- ← [[entities/Examination/Amyloid PET Imaging\|Amyloid PET Imaging]] (examination) - *Gold standard for amyloid*
...
OCT + OCT-A + AI analysis
       ↓
Risk score for neurodegeneration
       ↓
