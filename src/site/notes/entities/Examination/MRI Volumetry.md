---
{"dg-publish":true,"permalink":"/entities/examination/mri-volumetry/","tags":["examination","neuroimaging","mri","atrophy","neurodegeneration"]}
---
...
### Conditions
- → [[entities/condition/Alzheimer's Disease\|Alzheimer's Disease]] (condition) - *Hippocampal atrophy*
- → [[entities/condition/Mild Cognitive Impairment\|Mild Cognitive Impairment]] (condition) - *Predicts conversion*
- → [[entities/condition/Frontotemporal Dementia\|Frontotemporal Dementia]] (condition) - *Frontal pattern*
- → [[entities/condition/Huntington's Disease\|Huntington's Disease]] (condition) - *Caudate atrophy*
- → [[Progressive Supranuclear Palsy\|Progressive Supranuclear Palsy]] (condition) - *Midbrain atrophy*

### Brain Regions
- → [[entities/Organ/Hippocampus\|Hippocampus]] (organ) - *Key measurement*
- → [[entities/Organ/Entorhinal Cortex\|Entorhinal Cortex]] (organ) - *Earliest change*
- → [[entities/Organ/Prefrontal Cortex\|Prefrontal Cortex]] (organ) - *FTD involvement*

### Related Imaging
- ← [[entities/Examination/Amyloid PET Imaging\|Amyloid PET Imaging]] (examination) - *ATN A component*
- ← [[entities/Examination/Tau PET Imaging\|Tau PET Imaging]] (examination) - *ATN T component*
- ← [[entities/Examination/FDG-PET\|FDG-PET]] (examination) - *Functional correlate*

### Biomarkers
- → [[entities/biomarker/Neurofilament Light Chain\|Neurofilament Light Chain]] (biomarker) - *Correlates with atrophy*
- → [[entities/biomarker/Total Tau\|Total Tau]] (biomarker) - *Neurodegeneration marker*
