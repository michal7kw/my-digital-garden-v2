...
title: apoe_genotype
type: LabTest
updated: '2026-02-08T19:25:13.007496Z'
---

# APOE Genotype

## Overview
Tests APOE gene variants (E2, E3, E4). E4 associated with increased Alzheimer's and cardiovascular risk.
...
|----------|-------|
| **Category** | Genetic |
| **Subcategory** | Snp Panel || **Test Type** | Standard |
| **Sample Type** | Blood |
| **Collection Method** | Venipuncture |
| **Turnaround Time** | 7-14 days || **Price Range** | $99-$199 || **HSA Eligible** | ✅ Yes || **FSA Eligible** | ✅ Yes |
...
## Relationships
### Related
- → [[apoe_genotype]] (labtest)
```yaml
last_modified: '2026-01-26T07:07:50.001316'
source: obsidian
```
<!-- NEO4J_CONTENT_END -->
## Relationships
