---
created: '2026-02-08T19:29:31.663147Z'
...
permalink: /garden/dev_admin/labtest/advanced-lipid-panel/
slug: advanced-lipid-panel
tags:
- labtest
title: advanced_lipid_panel
type: labtest
updated: '2026-02-08T19:29:31.663147Z'
---

# Advanced Lipid Panel (NMR)

## Overview
NMR spectroscopy-based panel providing LDL particle number, size, HDL particles, and lipoprotein(a). Superior cardiovascular risk stratification.
...
| **Turnaround Time** | 3-7 days || **Price Range** | $75-$200 || **HSA Eligible** | ✅ Yes || **FSA Eligible** | ✅ Yes |
...
- → [[ldl_size]] (entity)
```yaml
last_modified: '2026-01-26T07:07:49.133041'
source: obsidian
```
- → [[apoB]] (entity)
```yaml
