---
created: '2026-02-08T19:29:31.704203Z'
...
type: labtest
updated: '2026-02-08T19:29:31.704203Z'
---

# Thyroid Panel (Complete)

## Overview
Comprehensive thyroid assessment: TSH, Free T4, Free T3, Total T4, Total T3, Reverse T3, TPO antibodies, thyroglobulin antibodies.
...
|----------|-------|
| **Category** | Hormones |
| **Subcategory** | Thyroid Complete || **Test Type** | Standard |
| **Sample Type** | Blood |
| **Collection Method** | Venipuncture |
| **Turnaround Time** | 2-5 days || **Price Range** | $125-$275 || **HSA Eligible** | ✅ Yes || **FSA Eligible** | ✅ Yes |
...
- ← [[reverse_t3]] (labtest)
```yaml
last_modified: '2026-01-26T06:48:25.282104'
source: obsidian
```
- → [[total_t3]] (entity)
```yaml
