---
created: '2026-02-08T19:45:44.551390Z'
...
type: labtest
updated: '2026-02-08T19:45:44.551390Z'
---

# Comprehensive Metabolic Panel (CMP)

## Overview
14-test panel measuring glucose, electrolytes, kidney function (BUN, creatinine), liver enzymes (ALT, AST, ALP), and proteins.
...
| **Turnaround Time** | 1-3 days || **Price Range** | $25-$65 || **HSA Eligible** | ✅ Yes || **FSA Eligible** | ✅ Yes |
## Fasting Requirements

⚠️ **Fasting Required**

- Fast for **10 hours** before the test
...
3. Take medications as usual unless advised otherwise
...
- ← [[potassium]] (labtest)
```yaml
last_modified: '2026-01-26T06:48:24.166096'
source: obsidian
```
...
- ← [[chloride]] (labtest)
```yaml
last_modified: '2026-01-26T06:48:10.483206'
source: obsidian
```
- ← [[calcium]] (labtest)
```yaml
last_modified: '2026-01-26T06:48:10.048669'
source: obsidian
```
- ← [[albumin]] (labtest)
```yaml
