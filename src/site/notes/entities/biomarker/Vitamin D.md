---
{"dg-publish":true,"permalink":"/entities/biomarker/vitamin-d/","tags":["biomarker"]}
---
...
### Other Relationships
### Has Biomarker
- ← [[entities/users/john_doe/biomarker_log\|biomarker_log]] (entity)
```yaml
...
### Affects Organ
- → [[entities/Organ/Bones\|Bones]] (organ)
```yaml
last_modified: '2025-12-28T11:01:27.751825'
source: obsidian
```
- → [[entities/Organ/Skin\|Skin]] (organ)
```yaml
last_modified: '2025-12-28T11:01:27.775939'
source: obsidian
```
- → [[Immune_System\|Immune_System]] (organ)
```yaml
last_modified: '2025-12-28T11:01:27.801524'
source: obsidian
```
- → [[entities/Organ/Muscles\|Muscles]] (organ)
```yaml
...
### Modulates Hormone
- → [[entities/biomarker/Insulin\|Insulin]] (biomarker)
```yaml
last_modified: '2025-12-28T11:01:27.851922'
source: obsidian
```
- → [[Thyroid_Hormones\|Thyroid_Hormones]] (hormone)
```yaml
...
source: obsidian
```
- → [[Vitamin_D\|Vitamin_D]] (biomarker)
```yaml
last_modified: '2026-01-19T09:30:31.497920'
source: obsidian
```
- → [[Immune_System\|Immune_System]] (entity)
```yaml
last_modified: '2026-01-19T09:30:31.497920'
source: obsidian
```
- → [[Thyroid_Hormones\|Thyroid_Hormones]] (entity)
```yaml
last_modified: '2026-01-19T09:30:31.497920'
source: obsidian
```
...
source: obsidian
```
- → [[25-Hydroxyvitamin_D\|25-Hydroxyvitamin_D]] (entity)
```yaml
last_modified: '2026-01-19T09:30:31.497920'
source: obsidian
```
- → [[Serum_Calcium\|Serum_Calcium]] (entity)
```yaml
last_modified: '2026-01-19T09:30:31.497920'
source: obsidian
```
...
source: obsidian
```
- → [[Fasting_Glucose\|Fasting_Glucose]] (entity)
```yaml
last_modified: '2026-01-19T09:30:31.497920'
source: obsidian
```
...
### Direct Tests
- [[vitamin d 25-hydroxy\|vitamin d 25-hydroxy]] - Vitamin D (25-OH) measurement
