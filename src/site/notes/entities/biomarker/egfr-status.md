...
dg-home: false
dg-publish: true
permalink: /entities/biomarker/egfr-status/
slug: egfr-status
tags:
- biomarker
- cancer
...
<h1>EGFR Status</h1>
<h2>Overview</h2>
<p>Predictive biomarker for lung and colorectal cancer. Measures EGFR protein expression (IHC) or gene mutations (PCR/NGS).</p>
<h2>Relationships</h2>
<h3>Related</h3>
...
RELATED::<a class="internal-link is-unresolved" href="/404">Lung_Cancer</a></p>
