---
{"dg-publish":true,"permalink":"/entities/pathway/autophagy-lysosomal-pathway/","tags":["pathway","neurodegeneration","autophagy","lysosome","proteostasis"]}
---
...
- → [[entities/condition/Alzheimer's Disease\|Alzheimer's Disease]] (condition) - *Lysosomal dysfunction*
- → [[entities/condition/Parkinson's Disease\|Parkinson's Disease]] (condition) - *Mitophagy defects*
- → [[entities/condition/Huntington's Disease\|Huntington's Disease]] (condition) - *Cargo recognition impaired*
- → [[entities/condition/Amyotrophic Lateral Sclerosis\|Amyotrophic Lateral Sclerosis]] (condition) - *Autophagy gene mutations*
- → [[entities/condition/Frontotemporal Dementia\|Frontotemporal Dementia]] (condition) - *C9orf72, GRN involvement*

### Related Pathways
- → [[entities/pathway/Mitophagy\|Mitophagy]] (pathway) - *Selective mitochondria autophagy*
- → [[Ubiquitin-Proteasome System\|Ubiquitin-Proteasome System]] (pathway) - *Complementary degradation*
- → [[mTOR Signaling\|mTOR Signaling]] (pathway) - *Master regulator*
- ← [[entities/protein/AMPK\|AMPK]] (protein) - *Autophagy activator*

### Pathological Cargo
- ← [[entities/pathway/Alpha-Synuclein Aggregation\|Alpha-Synuclein Aggregation]] (pathway) - *Cleared by autophagy*
- ← [[entities/pathway/Tau Phosphorylation\|Tau Phosphorylation]] (pathway) - *Tau degraded by autophagy/CMA*
- ← [[entities/pathway/Amyloid Cascade\|Amyloid Cascade]] (pathway) - *Aβ cleared by autophagy*

### Interventions
- ← [[entities/intervention/Caloric Restriction\|Caloric Restriction]] (intervention) - *Potent autophagy inducer*
- ← [[entities/intervention/Exercise\|Exercise]] (intervention) - *Activates AMPK, autophagy*
- ← [[entities/drug/Rapamycin\|Rapamycin]] (drug) - *mTOR inhibitor; autophagy inducer*
- ← [[entities/Supplement/Spermidine\|Spermidine]] (supplement) - *Autophagy enhancer*
- ← [[entities/intervention/Intermittent Fasting\|Intermittent Fasting]] (intervention) - *Autophagy activation*
